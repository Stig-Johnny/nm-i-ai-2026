...
def handle_create_product(base_url, token, e):
    ...
    price = e.get("priceExcludingVat") or e.get("priceExcVat") or e.get("price")
    if price is not None:
        body["priceExcludingVatCurrency"] = float(price)
    if e.get("priceIncludingVat") or e.get("priceIncVat"):
        body["priceIncludingVatCurrency"] = float(e.get("priceIncludingVat") or e.get("priceIncVat"))
